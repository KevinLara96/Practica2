...
int main() {
 ...
 //     
	...
	/*In this section, you can decide which projection to use: ortho or perspective.*/
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		/*view -> Matriz de cámara.
		model -> Matriz de objetos.*/
		...
		/*Second cube -> Right.*/
		model = glm::mat4(1); //The matrix is restarted, otherwise, the changes will be performed accumulatively.
		...
		/*Third cube -> Left.*/
		model = glm::mat4(1); //The model matrix is restarted.
		model = glm::translate(model, glm::vec3(-2.0f, 0.0f, 0.0f));
		...
		/*Seventh cube -> Lower right corner*/
		model = glm::mat4(1); //The model matrix is restarted.
		model = glm::translate(model, glm::vec3(1.0f, -3.0f, 0.0f));
